            ...
            <div class="row mb-none-30">
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--15 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            ...
                            <div class="desciption">
                                <span>@lang('Left Reward Points')</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--12 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            ...
                            <div class="desciption">
                                <span>@lang('Right Reward Points')</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--15 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                            @if(getAmount($user->userExtra->bv_left>getAmount($user->userExtra->bv_right)))         
                    <span class="amount">
                            {{getAmount($user->userExtra->bv_left)-getAmount($user->userExtra->bv_right)}}</span>
                    @else
                    <span class="amount">
                            0</span>
                        @endif
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--12 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                            @if(getAmount($user->userExtra->bv_right>getAmount($user->userExtra->bv_left)))         
                    <span class="amount">
                            {{getAmount($user->userExtra->bv_right)-getAmount($user->userExtra->bv_left)}}</span>
                    @else
                    <span class="amount">
                            0</span>
